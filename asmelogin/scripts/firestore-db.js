            ...
            if(doc.exists){
                 const userInfo = doc.data()
                    if(userInfo){
                      ...
                      <button class="logged-in" onclick="location.href='registrations.html'" style="margin-top:10px;color:white;background-color: rgb(73, 73, 73);cursor: pointer;padding: 10px;border-radius: 8px;text-align: center;box-shadow: 1px 3px 5px rgba(0,0,0,0.1);width: 100%;height: 100px;">Event Registrations</button>
